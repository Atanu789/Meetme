...
const wrapVariants: Record<'dark' | 'light' | 'create' | 'join', string> = {
  ...
  create: 'bg-gradient-to-r from-cyan-400 via-sky-500 to-emerald-400 shadow-[0_18px_40px_rgba(14,165,233,0.22)] hover:shadow-[0_24px_48px_rgba(14,165,233,0.28)]',
  join: 'bg-gradient-to-r from-amber-300 via-orange-400 to-rose-400 shadow-[0_18px_40px_rgba(249,115,22,0.22)] hover:shadow-[0_24px_48px_rgba(249,115,22,0.28)]',
};
...
const variants: Record<'dark' | 'light' | 'create' | 'join', string> = {
  ...
  create: 'bg-[linear-gradient(135deg,#06283d_0%,#0369a1_48%,#059669_100%)] px-6 py-3 text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.12)] group-hover:brightness-[1.03]',
  join: 'bg-[linear-gradient(135deg,#422006_0%,#c2410c_50%,#e11d48_100%)] px-6 py-3 text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.12)] group-hover:brightness-[1.03]',
};
